                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="">
                                ...
                                </svg> Page génération : <?= $data['page_generation'] ?>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="">
...
?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="modal" data-target="#myModal">
                                <span class="glyphicon glyphicon-user" aria-hidden="true"></span> Droits d'accès
                            </a>
                        </li>
                    </ul>
                </div>
