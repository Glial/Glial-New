...
class Test extends Controller
{
    ...
    function index()
    {
        ...
        $tab->addLine(array("2", Color::getColoredString("Testing Colors class, ".Color::getColoredString("Testing Colors class, this is purple string on yellow background.", "red", "blue")." is purple string on yellow background.",
                "purple", "yellow"), "dfxhxsfht6"));
