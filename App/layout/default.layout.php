...
//echo '<meta http-equiv="X-UA-Compatible" content="chrome=1"><meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no">';
echo '<meta charset="utf-8">';
...
//echo "<span>";<a href=\"".WWW_ROOT."\">".__("Home")."</a> ".$GLIALE_ARIANE."</span>";
                ...
                <div id="crumbs">
                    <ul>
                        <li><a href="#1"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> Accueil</a></li>
                        <li><a href="#2"><span class="glyphicon glyphicon-book" aria-hidden="true"></span> Documentation</a></li>
                        <li><a href="#3"><span class="glyphicon glyphicon-comment" aria-hidden="true"></span> Reportez un bug</a></li>
                        <li><a href="#4"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Panier (0)</a></li>
