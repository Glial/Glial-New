    ...
    <ul class="nav nav-pills flex-column">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#">
                ...
                </svg> Page génération : <?= $_SESSION['debug'][$data['last_key']]['page_generation'] ?>
        ...
        <li class="nav-item">
            <a class="nav-link" href="#">
                ...
                RAM : <?= $_SESSION['debug'][$data['last_key']]['memories'] ?>
            </a>
        </li>
