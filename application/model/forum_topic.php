...
class forum_topic extends Model
{
var $schema = "CREATE TABLE `forum_topic` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_forum_main` int(11) DEFAULT NULL,
  `id_user_main` int(11) DEFAULT NULL,
  `id_forum_post__first` int(11) DEFAULT NULL,
  `id_forum_post__last` int(11) DEFAULT NULL,
  ...
  `id_species_sub` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1";

var $field = array("id","id_forum_main","id_user_main","id_forum_post__first","id_forum_post__last","subject","posted","last_post","last_poster","num_views","num_replies","closed","sticky","moved_to","id_species_domain","id_species_kingdom","id_species_phylum","id_species_class","id_species_order","id_species_family","id_species_genus","id_species_main","id_species_sub");
...
var $validate = array(
	...
	'id_forum_post__first' => array(
		'reference_to' => array('The constraint to forum_post__first.id isn\'t respected.','forum_post__first', 'id')
	),
	'id_forum_post__last' => array(
		'reference_to' => array('The constraint to forum_post__last.id isn\'t respected.','forum_post__last', 'id')
	),
	'subject' => array(
