...
var $schema = "CREATE TABLE `contact_us` (
  ...
  CONSTRAINT `contact_us_ibfk_1` FOREIGN KEY (`id_geolocalisation_country`) REFERENCES `geolocalisation_country` (`id`),
  CONSTRAINT `contact_us_ibfk_2` FOREIGN KEY (`id_geolocalisation_city`) REFERENCES `geolocalisation_city` (`id`)
